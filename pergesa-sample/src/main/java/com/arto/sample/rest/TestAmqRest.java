 ...
 */
@Controller
@RequestMapping(value = "/test/amq/")
public class TestAmqRest {
    ...
    @Producer(type = MqTypeEnum.ACTIVEMQ, destination = "q-test-medium", priority = MessagePriorityEnum.MEDIUM)
    private MqProducer<OrderDO> mediumProducer;

    @Producer(type = MqTypeEnum.ACTIVEMQ, destination = "q-test-low", priority = MessagePriorityEnum.LOW)
