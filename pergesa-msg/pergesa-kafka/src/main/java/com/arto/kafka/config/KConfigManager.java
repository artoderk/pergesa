...
public class KConfigManager {
    ...
    private static class KafkaConfigHolder{
        public static KConfigManager instance = new KConfigManager();
    }

    public static KConfigManager getInstance(){
        return KConfigManager.KafkaConfigHolder.instance;
    }

    public static int getInt(String name, int value){
        String val = KConfigManager.getInstance().getValue(name);
        int result = value;
    ...
    public static String getString(String name, String value){
        String result = KConfigManager.getInstance().getValue(name);
